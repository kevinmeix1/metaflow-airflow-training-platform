...
def render_artifact_index(root: str | Path, *, title: str, description: str, dashboard: str) -> Path:
    ...
    cards = [
        ...
        ("Narrated Run Review", "narrated_demo_studio.html", "Timed operational walkthrough with natural voice backends, Remotion props, subtitle timing, and evidence-linked visuals."),
        ...
        ("Suspended Job Resources", "suspended_job_resources_plan.json", "Kubernetes v1.36 MutablePodResourcesForSuspendedJobs for queued partition backfills, HPO sweeps, and failed-partition replay right-sizing."),
        ("Constrained Impersonation", "constrained_impersonation_plan.json", "Kubernetes v1.36 ConstrainedImpersonation for least-privilege Airflow debugging and backfill support."),
...
<body>
  <main>
    <header>
      ...
      <span class="badge">Evidence Snapshot</span>
    </header>
    <section class="grid" aria-label="Generated artifacts">
      {card_html}
    </section>
    <footer>Run snapshot generated by <code>make demo</code>. Artifacts are deterministic and addressable by filename.</footer>
  </main>
</body>
</html>
"""
    ...
    output.write_text(decorate_console(body, active="evidence"), encoding="utf-8")
    return output
