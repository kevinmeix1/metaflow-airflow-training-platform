...
IDENTITY = ConsoleIdentity(
    product="Metaflow Training Operations",
    short_name="TrainOps",
    code="MF",
    environment="airflow / training-lab",
    primary="#35704b",
    primary_dark="#28563a",
    secondary="#6b5aa6",
    warning="#b66a17",
...
_NAVIGATION = (
    ("dashboard", "Run control", IDENTITY.dashboard),
    ("review", "Candidate review", "judge_demo_cockpit.html"),
    ("drill", "Recovery drill", "operator_drill_lab.html"),
    ("signals", "Training signals", "reliability_signal_mesh.html"),
    ("studio", "Demo runbook", "narrated_demo_studio.html"),
    ("evidence", "Artifact ledger", "index.html"),
)
